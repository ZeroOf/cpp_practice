...
std::shared_ptr<TcpIO::TestClient> StartSSL(boost::asio::thread_pool &threadPool,
...
int main(int argc, const char *argv[]) {
  std::shared_ptr<boost::asio::ssl::context>
      pSSLContext = std::make_shared<boost::asio::ssl::context>(boost::asio::ssl::context::tlsv13);
...
boost::shared_ptr<TcpIO::TestClient> Start(boost::asio::thread_pool &threadPool) {
  boost::shared_ptr<TcpIO::TestClient> pClient = boost::make_shared<TcpIO::TestClient>(threadPool, "127.0.0.1", "1133");
